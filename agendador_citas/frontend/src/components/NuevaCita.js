...
// withRouter para no perder los props, como el history, location, match, etc...
...
const NuevaCita = (props) => {
	...
	const crearNuevaCita = (e) => {
		...
		clienteAxios.post('/pacientes', cita).then((res) => {
